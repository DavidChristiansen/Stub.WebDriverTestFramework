...
using net.davedoes.acceptancetestframework.demo_nunit.Infrastructure.Remote;

namespace net.davedoes.acceptancetestframework.demo_nunit {
    [TestFixture]
    public class RemoteTestClass : RemoteTestBase {
        private string _remoteTestServerName = "myseleniumserver";
        public override string RemoteTestServerName {
            get { return _remoteTestServerName; }
        }
        [Test]
